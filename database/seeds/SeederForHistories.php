...
class SeederForHistories extends Seeder
{
    ...
    public function run()
    {
        ...
        $histories = array(
             ...
             */
            array('user_id' => $faker->randomElement([3, 4]),'patient_id' => 1,'history_type' => 'Medicamentos','med' => 'Sales rehidratantes','via' => 'Oral','date_ini' => $faker->date($format = 'd-m-Y', $max = 'now'),'created_at' => $faker->date($format = 'd-m-Y', $max = 'now')),
            array('user_id' => $faker->randomElement([3, 4]),'patient_id' => 1,'history_type' => 'Medicamentos','med' => 'Jarabe antitusivo','via' => 'Sublingual','date_ini' => $faker->date($format = 'd-m-Y', $max = 'now'),'created_at' => $faker->date($format = 'd-m-Y', $max = 'now')),
            array('user_id' => $faker->randomElement([3, 4]),'patient_id' => 1,'history_type' => 'Medicamentos','med' => 'Metformina','via' => 'Topica','date_ini' => $faker->date($format = 'd-m-Y', $max = 'now'),'created_at' => $faker->date($format = 'd-m-Y', $max = 'now')),
            array('user_id' => $faker->randomElement([3, 4]),'patient_id' => 1,'history_type' => 'Medicamentos','med' => 'Paracetamol','via' => 'Oral','date_ini' => $faker->date($format = 'd-m-Y', $max = 'now'),'created_at' => $faker->date($format = 'd-m-Y', $max = 'now')),
            array('user_id' => $faker->randomElement([3, 4]),'patient_id' => 1,'history_type' => 'Medicamentos','med' => 'Ibuprofeno','via' => 'Oral','date_ini' => $faker->date($format = 'd-m-Y', $max = 'now'),'created_at' => $faker->date($format = 'd-m-Y', $max = 'now')),
            array('user_id' => $faker->randomElement([3, 4]),'patient_id' => 1,'history_type' => 'Medicamentos','med' => 'Sales rehidratantes','via' => 'Oral','date_ini' => $faker->date($format = 'd-m-Y', $max = 'now'),'created_at' => $faker->date($format = 'd-m-Y', $max = 'now')),
            array('user_id' => $faker->randomElement([3, 4]),'patient_id' => 1,'history_type' => 'Medicamentos','med' => 'Sentis','via' => 'Oral','date_ini' => $faker->date($format = 'd-m-Y', $max = 'now'),'created_at' => $faker->date($format = 'd-m-Y', $max = 'now')),
            array('user_id' => $faker->randomElement([3, 4]),'patient_id' => 1,'history_type' => 'Medicamentos','med' => 'Paracetamol','via' => 'Oral','date_ini' => $faker->date($format = 'd-m-Y', $max = 'now'),'created_at' => $faker->date($format = 'd-m-Y', $max = 'now')),
            array('user_id' => $faker->randomElement([3, 4]),'patient_id' => 1,'history_type' => 'Medicamentos','med' => 'Ibuprofeno','via' => 'Oral','date_ini' => $faker->date($format = 'd-m-Y', $max = 'now'),'created_at' => $faker->date($format = 'd-m-Y', $max = 'now')),
            array('user_id' => $faker->randomElement([3, 4]),'patient_id' => 1,'history_type' => 'Medicamentos','med' => 'Diane','via' => 'Oral','date_ini' => $faker->date($format = 'd-m-Y', $max = 'now'),'created_at' => $faker->date($format = 'd-m-Y', $max = 'now')),
            array('user_id' => $faker->randomElement([3, 4]),'patient_id' => 1,'history_type' => 'Medicamentos','med' => 'Diane','via' => 'Oral','date_ini' => $faker->date($format = 'd-m-Y', $max = 'now'),'created_at' => $faker->date($format = 'd-m-Y', $max = 'now')),
            array('user_id' => $faker->randomElement([3, 4]),'patient_id' => 1,'history_type' => 'Medicamentos','med' => 'Resfriol','via' => 'Oral','date_ini' => $faker->date($format = 'd-m-Y', $max = 'now'),'created_at' => $faker->date($format = 'd-m-Y', $max = 'now')),
